...
<c:set var="hobbyVideoAll" value="${requestScope.REQ_HOBBY_VIDEO_ALL}" />

<div class="box-title container-box container">
	<div class="card">
		<div class="card-body">
			<h1 class="card-title">
				<strong>${hobbyVideoAll.get(0).hobby.name}爱好区</strong>
			</h1>
		</div>
		<img src="${hobbyVideoAll.get(0).hobby.hobbyPicture}"
...
<div class="container-box container">
	<div class="row">
		...
		<c:forEach var="video" items="${hobbyVideoAll}">
